...
print('softmax mod 3 test_error=', run_softmax_on_MNIST_mod3(temp_parameter=1.0))
...
# TODO: Fill out the PCA functions in features.py as the below code depends on them.
...
# TODO: Train the softmax regression model using (train_pca, train_y)
#       and evaluate its accuracy on (test_pca, test_y).


# TODO: Use the plot_PC function in features.py to produce scatter plot
...
# TODO: Fill out cubicFeatures() function in features.py as the below code requires it.
...
# TODO: Train the softmax regression model using (train_cube, train_y)
